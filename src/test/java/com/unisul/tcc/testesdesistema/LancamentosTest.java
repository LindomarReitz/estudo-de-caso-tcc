...
public class LancamentosTest {
	...
	private static String USER_NAME = "lindomarreitz";
	private static String USER_KEY = "75bdc1d2-6a3b-4a8c-8e83-d126085269e6";
	...
	public static void setUpClass() throws MalformedURLException {
		...
		capabilities.setCapability("version", "41");

		driver = new RemoteWebDriver(new URL("http://" + USER_NAME + ":" +
		USER_KEY + "@ondemand.saucelabs.com:80/wd/hub"), capabilities);
	...
	public void deveCadastrarUmDeposito() {
		...
		assertEquals("Lançamento salvo com sucesso!",
				paginaCadastro.getMensagemAlerta());
		assertTrue(lancamentos.existeNaListagem(descricao, dataLancamento,
				valor, observacao, nomeConta));
	...
	public void naoDeveCadastrarUmLancamentoComCamposEmBranco() {
		...
		assertTrue(paginaCadastro.getMensagemAlerta().contains(
				"O campo descrição não pode estar em branco!"));
	}
	...
	public void naoDeveCadastrarUmLancamentoComValorZero() {
		...
		assertTrue(paginaCadastro.getMensagemAlerta().contains(
				"O campo valor não pode ser zero!"));
	}
	...
	public void deveEditarUmLancamento() {
		...
		assertEquals("Lançamento editado com sucesso!",
				paginaEdicao.getMensagemAlerta());
		assertTrue(lancamentos.existeNaListagem(descricao, dataLancamento,
				novoValor, observacao, nomeConta));
	...
	public void naoDeveEditarUmLancamentoComOsCamposEmBranco() {
		...
		assertTrue(paginaEdicao.getMensagemAlerta().contains(
				"O campo descrição não pode estar em branco!"));
	}
	...
	public void deveExcluirUmLancamento() {
		...
		assertEquals("Lançamento excluído com sucesso!",
				lancamentos.getMensagemAlerta());
		assertFalse(lancamentos.existeNaListagem(descricao, dataLancamento,
				valor, observacao, nomeConta));
