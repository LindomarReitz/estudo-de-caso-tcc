...
insert into contas (nome, numero_agencia, numero_conta, saldo_anterior, saldo_atual, id_usuario, id_banco) values ('Conta corrente PF', 123, 456, 0, 0, 1, 2);
insert into contas (nome, numero_agencia, numero_conta, saldo_anterior, saldo_atual, id_usuario, id_banco) values ('Conta corrente PJ', 123, 456, 0, 0, 1, 1);
